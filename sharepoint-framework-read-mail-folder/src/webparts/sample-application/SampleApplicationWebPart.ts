...
import * as strings from 'SampleApplicationStrings';
import { ISampleApplicationWebPartProps } from './ISampleApplicationWebPartProps';
import { SampleApplicationUserProps } from './SampleApplicationUserProps';

export default class SampleApplicationWebPart extends BaseClientSideWebPart<ISampleApplicationWebPartProps> {

  private userProperties: SampleApplicationUserProps;
