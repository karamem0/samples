...
{
    /// <summary>
    /// Represents the Entity Framework (EF) model for database object '[SampleApplication].[Product]'.
    /// </summary>
    public partial class Product
    {
        ...
        public static void AddToModel(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Product", "SampleApplication");
                entity.HasKey(nameof(ProductId));
                entity.Property(p => p.ProductId).HasColumnName("ProductId").HasColumnType("UNIQUEIDENTIFIER");
                entity.Property(p => p.ProductName).HasColumnName("ProductName").HasColumnType("NVARCHAR(255)");
                entity.Property(p => p.Price).HasColumnName("Price").HasColumnType("DECIMAL(15, 0)");
        ...
        /// </summary>
        static partial void AddToModel(EntityTypeBuilder<Product> entity);
    }
}
