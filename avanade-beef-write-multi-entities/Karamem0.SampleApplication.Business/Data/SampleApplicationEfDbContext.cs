...
namespace Karamem0.SampleApplication.Business.Data
{
    ...
    public class SampleApplicationEfDbContext : DbContext, IEfDbContext
    {
        ...
        public SampleApplicationEfDbContext(DbContextOptions<SampleApplicationEfDbContext> options, IDatabase db) : base(options) => BaseDatabase = Check.NotNull(db, nameof(db));
