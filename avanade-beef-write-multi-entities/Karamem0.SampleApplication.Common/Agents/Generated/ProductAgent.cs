...
namespace Karamem0.SampleApplication.Common.Agents
{
    ...
    public partial interface IProductAgent
    {
        ...
        /// <param name="requestOptions">The optional <see cref="WebApiRequestOptions"/>.</param>
        /// <returns>A <see cref="WebApiAgentResult"/>.</returns>
        Task<WebApiAgentResult<Product>> UpdateAsync(Product value, Guid productId, WebApiRequestOptions? requestOptions = null);
    }
    ...
    public partial class ProductAgent : WebApiAgentBase, IProductAgent
    {
        ...
        /// <param name="requestOptions">The optional <see cref="WebApiRequestOptions"/>.</param>
        /// <returns>A <see cref="WebApiAgentResult"/>.</returns>
        public Task<WebApiAgentResult<Product>> UpdateAsync(Product value, Guid productId, WebApiRequestOptions? requestOptions = null) =>
            PutAsync<Product>("products/{productId}", Beef.Check.NotNull(value, nameof(value)), requestOptions: requestOptions,
                args: new WebApiArg[] { new WebApiArg<Guid>("productId", productId) });
    }
}
